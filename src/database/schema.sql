-- Database schema for multilingual terms and conditions
-- This is a mock schema that would be used in a real PostgreSQL database

-- Language table
CREATE TABLE languages (
    id SERIAL PRIMARY KEY,
    code VARCHAR(5) NOT NULL UNIQUE, -- 'en', 'sv'
    name VARCHAR(50) NOT NULL, -- 'English', 'Svenska'
...
CREATE TABLE content_sections (
    id SERIAL PRIMARY KEY,
    section_key VARCHAR(100) NOT NULL UNIQUE, -- 'nav_home', 'nav_order', 'terms_title', etc.
    description TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
INSERT INTO languages (code, name, flag_url) VALUES
('en', 'English', 'https://storage.123fakturere.no/public/flags/GB.png'),
('sv', 'Svenska', 'https://storage.123fakturere.no/public/flags/SE.png');

-- Insert content sections
INSERT INTO content_sections (section_key, description) VALUES
('nav_home', 'Navigation - Home'),
('nav_order', 'Navigation - Order'),
('nav_customers', 'Navigation - Our Customers'),
('nav_about', 'Navigation - About us'),
('nav_contact', 'Navigation - Contact us'),
('terms_title', 'Terms page title'),
('close_button', 'Close and go back button text'),
('terms_content', 'Main terms and conditions content');

-- Insert English content
INSERT INTO multilingual_content (section_id, language_id, content) VALUES
(1, 1, 'Home'),
(2, 1, 'Order'),
(3, 1, 'Our Customers'),
(4, 1, 'About us'),
(5, 1, 'Contact us'),
(6, 1, 'Terms'),
(7, 1, 'Close and Go Back'),
(8, 1, 'BY clicking Invoice Now, you choose to register according to the information that you have typed in and the text on the registration page and the terms here, and you at the same time accept the terms here.
...
(5, 2, 'Kontakta oss'),
(6, 2, 'Villkor'),
(7, 2, 'Stäng och gå tillbaka'),
(8, 2, 'GENOM ATT klicka på Fakturera Nu så väljer ni att registrera enligt den information som ni har lagt in och texten på registrerings sidan och villkoren här, och accepterar samtidigt villkoren här.
